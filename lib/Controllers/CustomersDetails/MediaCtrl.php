...
class MediaCtrl extends Controller {
	...
	public static function checkMedia(Request $request, $file_name) {
		...
		} else if (!isset($body['added']) || !\DateTime::createFromFormat('Y-m-d H:i:s', $body['added'])) {
			$is_correct = false; $http_status = 400; $msg .= 'added has to be YYYY-MM-DD hh:mm:ss format, like 2021-01-01 02:09:54<br>';
		}
